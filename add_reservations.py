...
class AddReservations(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.entry_image_1 = PhotoImage(file=relative_to_assets("add_reservations_entry_1.png"))
        ...
        self.entry_image_2 = PhotoImage(file=relative_to_assets("add_reservations_entry_2.png"))
        ...
        self.entry_image_3 = PhotoImage(file=relative_to_assets("add_reservations_entry_3.png"))
        ...
        self.entry_image_4 = PhotoImage(file=relative_to_assets("add_reservations_entry_4.png"))
        ...
        self.entry_image_5 = PhotoImage(file=relative_to_assets("add_reservations_entry_5.png"))
        ...
        self.entry_image_6 = PhotoImage(file=relative_to_assets("add_reservations_entry_6.png"))
        ...
        self.entry_image_7 = PhotoImage(file=relative_to_assets("add_reservations_entry_7.png"))
        ...
        self.entry_image_8 = PhotoImage(file=relative_to_assets("add_reservations_entry_8.png"))
        ...
        self.button_image_1 = PhotoImage(file=relative_to_assets("reserve.png"))
        button_1 = Button(
            self,
        ...
        self.button_image_2 = PhotoImage(file=relative_to_assets("add_reservations_button_2.png"))
        button_2 = Button(
            self,
        ...
        self.button_image_3 = PhotoImage(file=relative_to_assets("add_reservations_button_3.png"))
        button_3 = Button(
            self,
