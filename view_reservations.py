...
class ViewReservations(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.image_image_1 = PhotoImage(file=relative_to_assets("view_rooms_image_1.png"))
        image_1 = self.canvas.create_image(666.0, 59.0, image=self.image_image_1)

        self.entry_image_1 = PhotoImage(file=relative_to_assets("view_rooms_entry_1.png"))
        ...
        self.button_image_1 = PhotoImage(file=relative_to_assets("refresh.png"))
        ...
        self.image_image_2 = PhotoImage(file=relative_to_assets("view_rooms_image_2.png"))
        image_2 = self.canvas.create_image(617.0, 60.0, image=self.image_image_2)

        self.button_image_2 = PhotoImage(file=relative_to_assets("previous.png"))
        ...
        self.button_image_3 = PhotoImage(file=relative_to_assets("delete.png"))
        ...
        self.button_image_4 = PhotoImage(file=relative_to_assets("edit.png"))
        ...
        # Add sample data
        self.button_image_5 = PhotoImage(file=relative_to_assets("checkout.png"))
