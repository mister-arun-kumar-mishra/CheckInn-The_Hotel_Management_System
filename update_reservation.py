...
class UpdateReservations(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.button_image_1 = PhotoImage(file=relative_to_assets("previous.png"))
        button_1 = Button(
            self,
        ...
        self.image_image_1 = PhotoImage(file=relative_to_assets("update_reservations_image_1.png"))
        ...
        self.image_image_2 = PhotoImage(file=relative_to_assets("update_reservations_image_2.png"))
        ...
        self.entry_image_1 = PhotoImage(file=relative_to_assets("update_reservations_entry_1.png"))
        ...
        self.image_image_3 = PhotoImage(file=relative_to_assets("update_reservations_image_3.png"))
        ...
        self.entry_image_2 = PhotoImage(file=relative_to_assets("update_reservations_entry_2.png"))
        ...
        self.image_image_4 = PhotoImage(file=relative_to_assets("update_reservations_image_4.png"))
        ...
        self.entry_image_3 = PhotoImage(file=relative_to_assets("update_reservations_entry_2.png"))
        ...
        self.image_image_5 = PhotoImage(file=relative_to_assets("update_reservations_image_5.png"))
        ...
        self.entry_image_4 = PhotoImage(file=relative_to_assets("update_reservations_entry_2.png"))
        ...
        self.image_image_6 = PhotoImage(file=relative_to_assets("update_reservations_image_6.png"))
        ...
        self.entry_image_5 = PhotoImage(file=relative_to_assets("update_reservations_entry_2.png"))
        ...
        self.image_image_7 = PhotoImage(file=relative_to_assets("update_reservations_image_7.png"))
        ...
        self.entry_image_6 = PhotoImage(file=relative_to_assets("update_reservations_entry_2.png"))
        ...
        self.image_image_8 = PhotoImage(file=relative_to_assets("update_reservations_image_8.png"))
        ...
        self.entry_image_7 = PhotoImage(file=relative_to_assets("update_reservations_entry_2.png"))
        ...
        self.button_image_2 = PhotoImage(file=relative_to_assets("update.png"))
        button_2 = Button(
            self,
