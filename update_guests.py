...
class UpdateGuests(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.image_image_1 = PhotoImage(file=relative_to_assets("update_guests_image_1.png"))
        ...
        self.image_image_2 = PhotoImage(file=relative_to_assets("update_guests_image_2.png"))
        ...
        self.entry_image_1 = PhotoImage(file=relative_to_assets("update_guests_entry_1.png"))
        ...
        self.image_image_3 = PhotoImage(file=relative_to_assets("update_guests_image_3.png"))
        ...
        self.entry_image_2 = PhotoImage(file=relative_to_assets("update_guests_entry_2.png"))
        ...
        self.image_image_4 = PhotoImage(file=relative_to_assets("update_guests_image_4.png"))
        ...
        self.entry_image_3 = PhotoImage(file=relative_to_assets("update_guests_entry_3.png"))
