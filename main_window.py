...
from reservation_main import Reservations
from about import About
from rooms_main import Rooms
from guests_main import Guests
...
class MainWindow(Toplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("CheckInn - The complete solution")
        ...
        button_image_1 = PhotoImage(file=relative_to_assets("main_window_button_1.png"))
        self.dashboard_btn = Button(
            ...
            cursor='hand2', activebackground="#28a745",
            relief="flat",
        )
        self.dashboard_btn.place(x=7.0, y=133.0, width=208.0, height=47.0)

        button_image_2 = PhotoImage(file=relative_to_assets("main_window_button_2.png"))
        ...
        button_image_3 = PhotoImage(file=relative_to_assets("main_window_button_3.png"))
        ...
        button_image_4 = PhotoImage(file=relative_to_assets("main_window_button_4.png"))
        ...
        button_image_5 = PhotoImage(file=relative_to_assets("main_window_button_5.png"))
        ...
        self.logout_btn.place(x=0.0, y=441.0, width=208.0, height=47.0)

        button_image_6 = PhotoImage(file=relative_to_assets("main_window_button_6.png"))
