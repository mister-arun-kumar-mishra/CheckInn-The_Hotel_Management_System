...
class AddRooms(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.image_image_1 = PhotoImage(file=relative_to_assets("add_rooms_image_1.png"))
        ...
        self.entry_image_1 = PhotoImage(file=relative_to_assets("add_rooms_entry_1.png"))
        ...
        self.image_image_2 = PhotoImage(file=relative_to_assets("add_rooms_image_2.png"))
        ...
        self.entry_image_2 = PhotoImage(file=relative_to_assets("add_rooms_entry_2.png"))
        ...
        self.image_image_3 = PhotoImage(file=relative_to_assets("add_rooms_image_3.png"))
        ...
        self.entry_image_3 = PhotoImage(file=relative_to_assets("add_rooms_entry_3.png"))
        ...
        self.button_image_1 = PhotoImage(file=relative_to_assets("add_rooms.png"))
        button_1 = Button(
            self,
        ...
        self.button_image_2 = PhotoImage(file=relative_to_assets("add_rooms_button_2.png"))
        button_2 = Button(
            self,
        ...
        self.button_image_3 = PhotoImage(file=relative_to_assets("add_rooms_button_3.png"))
        button_3 = Button(
            self,
