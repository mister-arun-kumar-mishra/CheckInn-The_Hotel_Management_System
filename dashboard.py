...
class Dashboard(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        canvas.entry_image_1 = PhotoImage(file=relative_to_assets("dashboard_entry_1.png"))
        ...
        canvas.entry_image_2 = PhotoImage(file=relative_to_assets("dashboard_entry_2.png"))
        ...
        canvas.entry_image_3 = PhotoImage(file=relative_to_assets("dashboard_entry_3.png"))
        ...
        canvas.entry_image_4 = PhotoImage(file=relative_to_assets("dashboard_entry_4.png"))
        ...
        canvas.entry_image_5 = PhotoImage(file=relative_to_assets("dashboard_entry_5.png"))
        ...
        canvas.entry_image_6 = PhotoImage(file=relative_to_assets("dashboard_entry_6.png"))
        ...
        canvas.entry_image_7 = PhotoImage(file=relative_to_assets("dashboard_entry_7.png"))
        ...
        canvas.entry_image_8 = PhotoImage(file=relative_to_assets("dashboard_entry_8.png"))
        ...
        canvas.entry_image_9 = PhotoImage(file=relative_to_assets("dashboard_entry_9.png"))
        ...
        canvas.entry_image_10 = PhotoImage(file=relative_to_assets("dashboard_entry_10.png"))
        ...
        canvas.entry_image_11 = PhotoImage(file=relative_to_assets("dashboard_entry_11.png"))
        ...
        canvas.entry_image_12 = PhotoImage(file=relative_to_assets("dashboard_entry_12.png"))
        ...
        canvas.entry_image_13 = PhotoImage(file=relative_to_assets("dashboard_entry_13.png"))
        ...
        canvas.entry_image_14 = PhotoImage(file=relative_to_assets("dashboard_entry_14.png"))
        ...
        canvas.entry_image_15 = PhotoImage(file=relative_to_assets("dashboard_entry_15.png"))
        ...
        canvas.image_image_1 = PhotoImage(file=relative_to_assets("salesman.png"))
