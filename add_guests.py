...
class AddGuests(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.image_image_1 = PhotoImage(file=relative_to_assets("add_guests_image_1.png"))
        ...
        self.entry_image_1 = PhotoImage(file=relative_to_assets("add_guests_entry_1.png"))
        ...
        self.image_image_2 = PhotoImage(file=relative_to_assets("add_guests_image_2.png"))
        ...
        self.entry_image_2 = PhotoImage(file=relative_to_assets("add_guests_entry_2.png"))
        ...
        self.image_image_3 = PhotoImage(file=relative_to_assets("add_guests_image_3.png"))
        ...
        self.entry_image_3 = PhotoImage(file=relative_to_assets("add_guests_entry_3.png"))
        ...
        self.image_image_4 = PhotoImage(file=relative_to_assets("add_guests_image_4.png"))
        ...
        self.entry_image_4 = PhotoImage(file=relative_to_assets("add_guests_entry_4.png"))
        ...
        self.button_image_1 = PhotoImage(file=relative_to_assets("add_guest.png"))
        button_1 = Button(
            self,
        ...
        self.button_image_2 = PhotoImage(file=relative_to_assets("add_guests_button_2.png"))
        button_2 = Button(
            self,
        ...
        self.button_image_3 = PhotoImage(file=relative_to_assets("add_guests_button_3.png"))
        button_3 = Button(
            self,
